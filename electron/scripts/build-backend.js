...
const hiddenImports = [
  ...
  // Review engine
  'app.review_engine.registry',
  'app.review_engine.base',
  'app.review_engine.switchgear',
  'app.review_engine.ups',
  'app.review_engine.pdu',
  'app.review_engine.generator',
  'app.review_engine.transformer',
  'app.review_engine.ats',
  'app.review_engine.cable',
  'app.review_engine.bus_duct',
  'app.review_engine.panelboard',
  'app.review_engine.rpp',
  'app.review_engine.sts',
  'app.review_engine.battery',
  'app.review_engine.cooling',
  // Services (lazy-imported by routers)
  'app.services.review_service',
  'app.services.full_review_service',
  'app.services.pdf_parser',
  'app.services.pdf_annotator',
  'app.services.approval_stamp',
  'app.services.report_generator',
  'app.services.revision_diff',
  'app.services.smart_verify',
  'app.services.vision_analyzer',
  'app.services.vision_batch',
  'app.services.nec_commentary',
  'app.services.multi_submittal',
  'app.services.spec_validator',
  'app.services.page_classifier',
  'app.services.equipment_extractor',
  'app.services.email_generator',
  'app.services.smtp_service',
  'app.services.profile_loader',
  'app.services.update_checker',
  'app.services.learning',
  'app.services.engineering_tables',
  'app.services.topology',
  'app.services.coordination',
  'app.services.deep_checks',
  'app.services.sld_schedule_crosscheck',
  'app.services.naming_checker',
  'app.services.jurisdiction',
  // Manufacturer data
  'app.services.manufacturer_data',
  'app.services.manufacturer_data.abb',
  'app.services.manufacturer_data.eaton',
  'app.services.manufacturer_data.siemens',
  'app.services.manufacturer_data.schneider',
  // Third-party
